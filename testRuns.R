...
simGrid <- expand.grid(list(sharp = c(FALSE),
                            resp = c(.4),
...
for (i in 1:dim(simGrid)[1]) {
  ...
  with(simGrid, 
       assign(paste0("d2small.r", resp[i] * 10, ".exch",
              ...
              sim(n = 500, gammas = gammas, lambdas = lambdas, r1 = r1, r0 = r0, times = times, spltime = spltime,
                  ...
                  niter = niter, notify = notify, save.data = T,
