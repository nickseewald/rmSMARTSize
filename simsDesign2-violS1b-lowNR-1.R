...
save(file = "simsDesign2-delta3-violS1b-lowNR-1.RData",
...
save(file = "simsDesign2-delta5-violS1b-lowNR-1.RData",
     list = c("sigma", "sigma.r1", "sigma.r0",
              "gammas", "lambdas", "seed", "times", "spltime"))
...
save(file = "simsDesign2-delta8-violS1b-lowNR-1.RData",
     list = c("sigma", "sigma.r1", "sigma.r0",
              "gammas", "lambdas", "seed", "times", "spltime"))
