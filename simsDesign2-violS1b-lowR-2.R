...
save(file = "simsDesign2-delta3-violS1b-lowR-max.RData",
...
if (notify)
  slackr_bot("All simulations are complete for effect size 0.3, violation of S1(b) with low responder correlation")
...
save(file = "simsDesign2-delta5-violS1b-lowR-max.RData",
     list = c("sigma", "sigma.r1", "sigma.r0",
              "gammas", "lambdas", "seed", "times", "spltime"))
...
if (notify)
  slackr_bot("All simulations are complete for effect size 0.5, violation of S1(b) with low responder correlation")

## Effect size: 0.8
gammas <- c(33.5, -0.8, 1.5, -0.8, 1.3, -0.4, 0.1)
lambdas <- c(0.1, -0.5)

save(file = "simsDesign2-delta8-violS1b-lowR-max.RData",
     list = c("sigma", "sigma.r1", "sigma.r0",
              "gammas", "lambdas", "seed", "times", "spltime"))
...
if (notify)
  slackr_bot("All simulations are complete for effect size 0.8, violation of S1(b) with low responder correlation")
