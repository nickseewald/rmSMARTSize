  ...
  assign(simGrid.delta3$simName[scenario],
         try(
           simulateSMART(gammas = gammas, lambdas = lambdas, r1 = r1, r0 = r0, 
                         ...
                         alpha = .05, power = .8, delta = 0.3, design = 1, 
                         conservative = !sharp,
                         sigma = sigma, sigma.r1 = sigma.r1,
                         sigma.r0 = sigma.r0,
                         variances = vars,
                         pool.time = TRUE, L = c(0, 0, 2, 0, 2, 2, 2, 0, 0),
...
save(file = here("Results", "simsDesign1-delta5-basic.RData"),
...
for (scenario in 1:nrow(simGrid.delta5)) {
  ...
  assign(simGrid.delta5$simName[scenario],
         try(
           simulateSMART(gammas = gammas, lambdas = lambdas, r1 = r1, r0 = r0,
                         times = times, spltime = spltime,
                         alpha = .05, power = .8, delta = 0.5, design = 1,
                         conservative = !sharp,
                         sigma = sigma, sigma.r1 = sigma.r1,
                         sigma.r0 = sigma.r0,
                         variances = vars,
...
save(file = here("Results", "simsDesign1-delta8-basic.RData"),
...
for (scenario in 1:nrow(simGrid.delta8)) {
  ...
  assign(simGrid.delta8$simName[scenario],
         try(
           simulateSMART(gammas = gammas, lambdas = lambdas, r1 = r1, r0 = r0,
                         times = times, spltime = spltime,
                         alpha = .05, power = .8, delta = 0.8, design = 1,
                         conservative = !sharp,
                         sigma = sigma, sigma.r1 = sigma.r1,
                         sigma.r0 = sigma.r0,
                         variances = vars,
