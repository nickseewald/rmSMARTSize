...
gammas <- c(35, -4, 2.3, -1.6, -1.1, 0.4, -0.4, 0.4, 0.4)
lambdas <- c(0.3, 0.4)

simGrid.delta3 <- computeVarGrid(simGrid, times, spltime, gammas,
                                 sigma, corstr = "ar1", design = 1,
...
save(file = here("Results", "simsDesign1-delta3-ar1-paper.RData"),
...
save(file = here("Results", "simsDesign1-delta5-ar1-paper.RData"),
