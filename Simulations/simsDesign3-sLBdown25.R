...
gammas <- c(35, -0.5, 1.2, 0.2, -0.3, 0.6)
lambdas <- c(0.8, 0)
...
save(file = here("Results", "simsDesign3-delta3-sLBdown25.RData"),
...
gammas <- c(35, -0.5, 1.5, 0.2, 1.1, 1.2)
lambdas <- c(0.8, 0)
