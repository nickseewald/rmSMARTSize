...
save(file = here("Results", "simsDesign1-delta3-sLBdown25-paper.RData"),
...
gammas <- c(35, -4, 2.9, -1.6, -1.3, 0.4, -0.4, 0.4, 0.4)
lambdas <- c(0.3, 0.4)
...
save(file = here("Results", "simsDesign1-delta5-sLBdown25-paper.RData"),
